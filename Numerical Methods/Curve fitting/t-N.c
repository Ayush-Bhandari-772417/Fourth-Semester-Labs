...
void main(){
	...
	scanf("%d",&n);
	printf("Enter the respective values of the variables t and N in pairs:\n");
	for(i=1;i<=n;i++)
		scanf("%f%f",&x[i],&y[i]);
	printf("______________________________________________________________\n");
	...
	printf("The equation of the best fit of the line is N=%0.4f+(%0.4ft) \n",a,b);
	
	printf("______________________________________________________________\n\n");
	float val, xvar=4.5;
	val=a+b*xvar;
	printf("The value of N at t=4.5 is: %f", val);
